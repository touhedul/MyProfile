...
class ProfessionCategoryDataTable extends DataTable
{

    public function dataTable($query)
    {
        $dataTable = new EloquentDataTable($query);
        return $dataTable->addColumn('action', 'admin.profession_categories.datatables_actions')
            ->addIndexColumn()
            ->addColumn('', '')
            ->addColumn('Sl', '');
    ...
    public function query(ProfessionCategory $model)
    {
    ...
    public function html()
    {
        return $this->builder()
            ...
            ->parameters(AdminHelper::datatableDesign("ProfessionCategory","ProfessionCategory-delete"));
    }
    ...
    {
        return 'profession_categories_datatable_' . time();
    }
}
