...
class SkillListDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'admin.skill_lists.datatables_actions')
            ->addIndexColumn()
            ->addColumn('', '')
            ->addColumn('Sl', '');
    ...
    public function query(SkillList $model)
    {
    ...
    public function html()
    {
        return $this->builder()
            ...
            ->parameters(AdminHelper::datatableDesign("SkillList","SkillList-delete"));
    }
    ...
    {
        return 'skill_lists_datatable_' . time();
    }
}
