...
<div class="form-group">
    ...
    {!! Form::number('percentage', null, ['class' => 'form-control','required','min' => 0]) !!}
</div>
...
<div class="form-group">
    ...
    <a href="{{ route('admin.skills.index') }}" class="btn btn-danger"><i class="fa fa-window-close" aria-hidden="true"></i> {{ __("Cancel") }}</a>
</div>
