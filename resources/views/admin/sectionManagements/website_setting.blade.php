                ...
                <div class="card-body">
                    <form action="{{ route('admin.websiteSettings.save') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                Theme Color
                                <input type="color" placeholder="Theme Color" name="theme_color" value="{{$websiteSettings->where('key','theme_color')->first()->value}}" class="form-control col-md-6">
                                <br>
                                Header Color <br>
                                <input type="color" placeholder="Theme Color" name="header_color" value="{{$websiteSettings->where('key','header_color')->first()->value}}" class="form-control col-md-6">
                                <br>
                                Footer Color
                                <input type="color" placeholder="Theme Color" name="footer_color" value="{{$websiteSettings->where('key','footer_color')->first()->value}}" class="form-control col-md-6">
                                <br>
                            </div>
                        </div>
                        <br>
