                                ...
                                <tbody>
                                    @forelse ($userMenus as $userMenu)
                                        <tr>
                                            ...
                                            <td><input required maxlength="30" autofocus class="form-control" type="text"
                                                    name="menu_titles[]" value="{{ $userMenu->menu_title }}" /></td>
                                            <td>

                                                @if ($userMenu->background_color)
                                                    <input type="color" class="form-control" name="background_colors[]"
                                                        value="{{ $userMenu->background_color }}">
                                                @else
                                                    <div style="display: none">
                                                        <input type="text" class="form-control"
                                                            name="background_colors[]" value="">
                                                    </div>
                                                @endif
                                            </td>
                                            <td>
                                                <div class="form-group">
                                                    <div class="custom-control custom-switch">
                                                        <input name="show_status[]" value="{{ $userMenu->id }}"
                                                            @if ($userMenu->show_status == 1) checked @endif type="checkbox"
                                                            class="custom-control-input"
                                                            id="customSwitch{{ $userMenu->id }}">
                                                        <label class="custom-control-label"
                                                            for="customSwitch{{ $userMenu->id }}">{{ __('') }}</label>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
