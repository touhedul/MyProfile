...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <form id="settingsForm" method="POST" action="{{ route('admin.frontendCMS.pageUpdate', $frontendPage->id) }}"
                enctype="multipart/form-data">
                @csrf
                <div class="main-card mb-3 card">
                    <div class="card-header"> <span class="text-primary"> "{{ str_replace('_', ' ', $frontendPage->name) }}"
                            {{ __('Page Content') }} </span> </div>
                    <div class="card-body">
